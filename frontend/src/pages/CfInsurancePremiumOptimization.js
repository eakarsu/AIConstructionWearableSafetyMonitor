...
/**
 * Gap/CFS Feature Page: Insurance premium optimization
 * Slug: insurance-premium-optimization
 * Backend: /api/cf-insurance-premium-optimization
 */
export default function InsurancePremiumOptimizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-insurance-premium-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Insurance premium optimization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Real-time safety data feed to insurers for dynamic premium pricing.</p>
