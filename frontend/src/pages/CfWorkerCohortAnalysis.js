...
/**
 * Gap/CFS Feature Page: Worker cohort analysis
 * Slug: worker-cohort-analysis
 * Backend: /api/cf-worker-cohort-analysis
 */
export default function WorkerCohortAnalysisPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-worker-cohort-analysis', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Worker cohort analysis</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Identify high-risk teams; recommend pairing with experienced workers.</p>
