...
/**
 * Gap/CFS Feature Page: Predictive injury prevention
 * Slug: predictive-injury-prevention
 * Backend: /api/cf-predictive-injury-prevention
 */
export default function PredictiveInjuryPreventionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-injury-prevention', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive injury prevention</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model identifies workers at high injury risk; recommend personalized interventions (rotation, equipment, training).</p>
