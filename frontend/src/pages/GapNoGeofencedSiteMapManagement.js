...
/**
 * Gap/CFS Feature Page: No geofenced site-map management.
 * Slug: no-geofenced-site-map-management
 * Backend: /api/gap-no-geofenced-site-map-management
 */
export default function NoGeofencedSiteMapManagementPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-geofenced-site-map-management', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No geofenced site-map management.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No geofenced site-map management.</p>
