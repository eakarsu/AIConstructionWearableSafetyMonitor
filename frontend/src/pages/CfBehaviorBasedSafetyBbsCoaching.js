...
/**
 * Gap/CFS Feature Page: Behavior-based safety (BBS) coaching
 * Slug: behavior-based-safety-bbs-coaching
 * Backend: /api/cf-behavior-based-safety-bbs-coaching
 */
export default function BehaviorBasedSafetyBbsCoachingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-behavior-based-safety-bbs-coaching', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Behavior-based safety (BBS) coaching</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Track near-miss patterns; deliver just-in-time training via mobile app.</p>
