...
/**
 * Gap/CFS Feature Page: No insurance/liability tracking or claims module.
 * Slug: no-insurance-liability-tracking-or-claims-module
 * Backend: /api/gap-no-insurance-liability-tracking-or-claims-module
 */
export default function NoInsuranceLiabilityTrackingOrClaimsModulePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-insurance-liability-tracking-or-claims-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No insurance/liability tracking or claims module.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No insurance/liability tracking or claims module.</p>
